 ...
 * @param {string[]} tags - The tags for filtering recipes (optional).
 * @param {string} steps - The number of steps to filter by (optional).
 * @param {boolean} topRated - Flag to fetch top-rated recipes (optional).
 * @param {string} sortBy - Sorting criteria (e.g., 'price', 'rating', etc.)
 ...
 */
export async function fetchRecipes(page = 1, limit = 20, search = '', category = '', tags = [], steps = '', topRated = false, sortBy, sortOrder) {
  try {
    ...
    console.log("URL:", url.toString()); // Log the constructed URL
